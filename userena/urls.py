...
urlpatterns = patterns('',
    ...
    url(r'^password/reset/$',
       ...
       merged_dict({'template_name': 'userena/password_reset_form.html',
                    'email_template_name': 'userena/emails/password_reset_message.html',
    ...
    url(r'^password/reset/done/$',
       ...
       {'template_name': 'userena/password_reset_done.html','extra_context':{'login_form':LoginForm()},},
       name='userena_password_reset_done'),
    url(r'^password/reset/confirm/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$',
       auth_views.password_reset_confirm,
       merged_dict({'template_name': 'userena/password_reset_confirm_form.html','extra_context':{'login_form':LoginForm()},
                    }, auth_views_compat_quirks['userena_password_reset_confirm']),
       name='userena_password_reset_confirm'),
    url(r'^password/reset/confirm/complete/$',
       auth_views.password_reset_complete,
       {'template_name': 'userena/password_reset_complete.html','extra_context':{'login_form':LoginForm()},},
