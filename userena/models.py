...
import datetime
from userena.tasks import send_activate_mail, send_confirm_mail
...
class UserenaSignup(models.Model):
    ...
    def send_confirmation_email(self):
        ...
        new_email = self.email_unconfirmed
        confirmation_key =  self.email_confirmation_key
        template1 = 'userena/emails/confirmation_email_message_old.html'
        template2 = 'userena/emails/confirmation_email_message_new.html'
        site = 'houseofgrads.com'
        if self.user.email:
            send_confirm_mail.delay(subject_old,
                      message_old,template1,new_email,
                      userid,protocol,confirmation_key,site,
        ...
        if (not userena_settings.USERENA_HTML_EMAIL or not message_new_html or
            ...
            message_new = None
        send_confirm_mail.delay(subject_new,
                  message_new,template2,new_email,
                  userid,protocol,confirmation_key,site,
                  settings.DEFAULT_FROM_EMAIL,
    ...
    def send_activation_email(self):
        ...
        send_activate_mail.delay(subject,
                  ...
                  'HouseofGrads <admin@houseofgrads.com>',[self.user.email])
...
class UserenaBaseProfile(models.Model):
    ...
    mugshot = ThumbnailerImageField(_('mugshot'),
                                    ...
                                    help_text=_('A personal image displayed in your profile.'),default='/static/img/upload.png')
